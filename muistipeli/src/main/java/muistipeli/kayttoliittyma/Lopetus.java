...
/**
 *
 * Graafinen käyttöliittymä, joka aukeaa pelin lopussa. Sisältää pelitulokseen liittyvät tekstit ja 
 * painikkeen uuden pelin aloitukseen ja tarvittaessa tuloksen tallennukseen.
 */
public class Lopetus implements Runnable {
    ...
    private void teeHienoPinkkiNappula(JButton nappula) {
